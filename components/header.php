...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <div class="container">
    <a class="navbar-brand text-light" href="index.php"><i class="fas fa-gamepad "></i><span class="px-2">GAMERCASH</span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link active text-light" href="panier.php">Mon Panier</a>
      </div>
    </div>
  </div>
</nav>
